...
- Calidad: ` <REPO_ROOT>/Developer/agente_de_codigo/packages/agents/quality_agent.py`
- Seguridad: ` <REPO_ROOT>/Developer/agente_de_codigo/packages/agents/security_agent.py`
