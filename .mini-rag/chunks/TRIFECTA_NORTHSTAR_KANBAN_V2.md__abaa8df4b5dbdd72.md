...
- [ ] **Auditability Gates (G1-G3)** `#priority:med` `#plan:2026-01-02`
  - **Plan**: [`docs/plans/2026-01-02-auditability-gates-plan.md`](file://<REPO_ROOT>/Developer/agent_h/trifecta_dope/docs/plans/2026-01-02-auditability-gates-plan.md)
...
- [ ] **Constitution (AGENTS.md Phase 1)** `#priority:med` `#phase:1`
  ...
  - **Validator Exists**: `validate_agents_constitution()` in [`validators.py:165`](file://<REPO_ROOT>/Developer/agent_h/trifecta_dope/src/infrastructure/validators.py#L165)
