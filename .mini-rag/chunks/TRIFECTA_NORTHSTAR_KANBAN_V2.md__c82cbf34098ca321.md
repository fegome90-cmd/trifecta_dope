...
- [x] **Progressive Disclosure (Search/Get)** `#priority:high` `#phase:2`
  - **Trace**: [`src/application/context_service.py:35`](file://<REPO_ROOT>/Developer/agent_h/trifecta_dope/src/application/context_service.py#L35)
...
- [x] **Macro Load (PCC + Fallback)** `#priority:high` `#phase:2`
  - **Trace**: [`src/application/use_cases.py:488`](file://<REPO_ROOT>/Developer/agent_h/trifecta_dope/src/application/use_cases.py#L488)
