...
Dataset: <REPO_ROOT>/Developer/agent_h/trifecta_dope/.worktrees/t9-3-6-clamp-calibration/docs/plans/t9_plan_eval_tasks_v2_nl.md
...
Examples (hits with selected_feature):
  ...
  2. [nl_trigger] 'where would i find stats about
