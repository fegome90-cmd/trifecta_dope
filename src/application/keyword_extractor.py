...
class KeywordExtractor:
    ...
    def extract_from_skills(self, skills: Sequence[dict[str, str]]) -> list[ExtractedSkillKeywords]:
    ...
    def build_alias_map(self, extracted: Sequence[ExtractedSkillKeywords]) -> GeneratedAliasMap:
