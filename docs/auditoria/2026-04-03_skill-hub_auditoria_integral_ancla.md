...
- SH-003 queda cerrado canónicamente en gobernanza sobre la cadena runtime directa auditada de `skill-hub` y `skill-hub-cards`, con freeze técnico `0a3973cf`, receipt schema v2 y verify actual pasando.
- Este cierre no certifica corrección funcional total y no modifica el estado abierto de SH-006 ni SH-008.
